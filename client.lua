...
local rltNumbers = {"~g~0", "~r~1", "~c~2", "~r~3", "~c~4", "~r~5", "~c~6", "~r~7", "~c~8", "~r~9", "~c~10", "~c~11", "~r~12", "~c~13", "~r~14", "~c~15", "~r~16", "~c~17", "~r~18", "~r~19", "~c~20", "~r~21", "~c~22", "~r~23", "~c~24", "~r~25", "~c~26", "~r~27", "~c~28", "~c~29", "~r~30", "~c~31", "~r~32", "~c~33", "~r~34", "~c~35", "~r~36"}
...
local EmojiList = { --add/remove emojis to increse/decrease chances
	'🍒',
	'🍒',
	'🍒',
	'🍒',
...
function vRPcasinoC.checkWinSlotmachine(MoneyRecive,a,b,c) --If you changed #EmojiList I'd recommend you to make some changes to this function
	SlotMenu()
	Menu.hidden = not Menu.hidden
	if a == b and a == c then
		if a == '🍒' or a == '🍓' or a == '🍉' or a == '🍍' then 
			reward = tonumber(MoneyRecive*3)
			vRPcasinoS.winSlotMachine({reward})
		elseif a == '🔥' or a == '🍋' then
			reward = tonumber(MoneyRecive*4)
			vRPcasinoS.winSlotMachine({reward})
		elseif a == '⭐️' then
			reward = tonumber(MoneyRecive*5)
			vRPcasinoS.winSlotMachine({reward})
		elseif a == '💰' then
			reward = tonumber(MoneyRecive*8)
			vRPcasinoS.winSlotMachine({reward})
		elseif a == '👑' then
			reward = tonumber(MoneyRecive*9)
			vRPcasinoS.winSlotMachine({reward})
		else
			reward = tonumber(MoneyRecive*10)
			vRPcasinoS.winSlotMachine({reward})
		end
		Chat('JACKPOT!', a..' '..b..' '..c, 0, 255, 0)
		
	elseif a == b or b == c then
		if b == '🍒' or b == '🍓' or b == '🍉' or b == '🍍' then
			reward = tonumber(MoneyRecive*2)
			vRPcasinoS.winSlotMachine({reward})
		elseif b == '🔥' or b == '🍋' then
			reward = tonumber(MoneyRecive*3)
			vRPcasinoS.winSlotMachine({reward})
		elseif b == '⭐️' then
			...
			vRPcasinoS.winSlotMachine({reward})
		elseif b == '💰' then
			reward = tonumber(MoneyRecive*6)
			vRPcasinoS.winSlotMachine({reward})
		elseif b == '👑' then
			reward = tonumber(MoneyRecive*7)
			vRPcasinoS.winSlotMachine({reward})
		else
			reward = tonumber(MoneyRecive*8)
			vRPcasinoS.winSlotMachine({reward})
...
local moneymachine_slot = {
	{ ['x'] = 929.52633154296, ['y'] = -947.09130859375, ['z'] = 44.392375946044 },
	{ ['x'] = 929.52650195312, ['y'] = -948.58843994140, ['z'] = 44.392375946044 },
	{ ['x'] = 929.52614404296, ['y'] = -950.31072998046, ['z'] = 44.392375946044 },
	{ ['x'] = 929.52600048828, ['y'] = -952.01190185546, ['z'] = 44.392375946044 },
	{ ['x'] = 929.52630859375, ['y'] = -953.61248779296, ['z'] = 44.392375946044 },
	{ ['x'] = 929.52655322266, ['y'] = -955.14855957032, ['z'] = 44.392375946044 },
	{ ['x'] = 929.52634277344, ['y'] = -956.90930175782, ['z'] = 44.392375946044 },
	{ ['x'] = 929.52606298828, ['y'] = -958.53637695312, ['z'] = 44.392375946044 },----
	{ ['x'] = 935.00976562500, ['y'] = -947.09130859375, ['z'] = 44.392375946044 },
	{ ['x'] = 935.00976562500, ['y'] = -948.58843994140, ['z'] = 44.392375946044 },
	{ ['x'] = 935.00976562500, ['y'] = -950.31072998046, ['z'] = 44.392375946044 },
	{ ['x'] = 935.00976562500, ['y'] = -952.01190185546, ['z'] = 44.392375946044 },
	{ ['x'] = 935.00976562500, ['y'] = -953.61248779296, ['z'] = 44.392375946044 },
	{ ['x'] = 935.00976562500, ['y'] = -955.14855957032, ['z'] = 44.392375946044 },
	{ ['x'] = 935.00976562500, ['y'] = -956.90930175782, ['z'] = 44.392375946044 },
	{ ['x'] = 935.00976562500, ['y'] = -958.53637695312, ['z'] = 44.392375946044 }
}
